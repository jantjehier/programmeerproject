 ...
 // add axis text
  ...
  svg.selectAll(".bar")
    ...
    .enter().append("rect")
      ...
      .on('click', function(d,i){Bandid = d.artist; timeline(Bandid); piechart(Bandid); });
  ...
  // adding the width, height, radius, color.
    ...
    for (var l = 0; l < data.length; l++)
    {
      if (data[l].artist == BandId)
      {
        ...
        restalbums = data[l].totalsales - albumsalespart;
        albumdata2 = {"label":"albums with less than 20 million sales", "value": restalbums}
      }
    }
